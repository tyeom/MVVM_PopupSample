...
namespace MVVM_PopupSample.Services;
...
public interface IDialogService
{
    ...
    void SetVM(ObservableObject vm, string? title, double width, double height, EDialogHostType dialogHostType, bool isModal = true);
...
public class DialogService : IDialogService
{
    ...
    public void SetVM(ObservableObject vm, string? title, double width, double height, EDialogHostType dialogHostType, bool isModal = true)
    {
